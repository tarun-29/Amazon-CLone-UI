...
import {Container, Content, Header, Left, Right, Icon, Item,
        Input,
        Row,
        Card,CardItem
} from 'native-base'
...
//old native base version will not work remember that
    ...
    return (
      <Container>
          <Header style={{backgroundColor: '#3a455c', height: 90,
           borderBottomColor:'#75757'}}>
            <Left style={{flexDirection: 'row'}}>
                ...
                />
                <FAIcon
                    name="amazon" style={{fontSize: 32, color: 'white'}}
                />
            </Left>
            <Right>
                <Icon
        ...
        <View style={{position: 'absolute', left: 0, right: 0,
            top: 90, height: 70, backgroundColor: '#3a455c',
            flexDirection: 'row', alignItems: 'center', paddingHorizontal: 5
        }}>
            <TouchableOpacity>
                <View style={{width: 100, backgroundColor: '#e7e7eb',
                ...
                <View style={{flex: 1, height: "100%", marginLeft: 5,
         ...
         marginTop: 45}}>
            <View style={{height: 50, backgroundColor: 'white',
             ...
             justifyContent: 'space-between'}}>
                <Text>Hello Tarun</Text>
                <View style={{flexDirection:'row'}}>
                    <Text>Your Acccount </Text>
                </View>
            </View>
            <Swiper
                autoplay = {true}
